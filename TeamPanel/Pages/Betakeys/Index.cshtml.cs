...
{
    public class BetakeysIndexModel : PageModel
    {
        private MySqlConnection MySQL;

        public IEnumerable<BetaKey> BetaKeys;

        public Account LoginUser;

        public BetakeysIndexModel(MySqlConnection mySQL)
        {
            MySQL = mySQL;
        }
        ...
        public IActionResult OnGet()
        {
            ...
            if (LoginUser.ROLE != "admin") { return Redirect("/"); }

            BetaKeys = MySQL.GetAll<BetaKey>();
